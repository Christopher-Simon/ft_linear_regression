...
def predict(model_file: str) -> None:
    ...
    print(km_normalizer.params)
    print(price_normalizer.params)
...
if __name__ == "__main__":
    custom_path = sys.argv[1] if len(sys.argv) > 1 else "model/model_weights.json"
    predict(custom_path)
